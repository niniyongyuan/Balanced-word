...
/**
 * This is an implementation of the world which runs actors. The world contains
...
public class WorldImpl implements World {
	...
	// this queue has all actors which have already acted
	protected Queue<Actor> hasActed;

	// This map maps actors to the number of steps since their last move
	...
	public void add(Object newThing, Location loc) {
		...
		// AI ai = ((FoxImpl)newThing).getAI();
		// String s = this.aiToName.get(ai.getClass());
	 ...
	 *
	 * @return Returns false if there are no actors to step, true otherwise.
	 */
	@Override
	public boolean step() {
